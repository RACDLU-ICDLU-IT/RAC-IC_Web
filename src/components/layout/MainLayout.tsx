      ...
      >
        ...
        >
          {settings.logoUrl && !logoError ? (
            /* CSS mask technique — the SVG logo uses currentColor,
               so we drive color directly via backgroundColor on a masked div.
               Home/About unscrolled              → white
               Home/About scrolled + light primary → accent color
               Home/About scrolled + dark primary  → white
               All other pages (any scroll state)  → always accent color */
            <div
              role="img"
              ...
              style={{
                ...
                maskPosition: 'center',
                backgroundColor: (!isHomeOrAbout || (scrolled && isLight))
                  ? 'var(--color-accent)'
                  : '#ffffff',
