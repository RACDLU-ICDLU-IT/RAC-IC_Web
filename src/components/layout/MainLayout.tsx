...
export default function MainLayout() {
  ...
  const navSolid = !isHeroPage || (scrolled && !menuOpen);
  ...
  useEffect(() => {
    ...
    if (menuOpen) {
      ...
      gsap.fromTo(
        ...
        { clipPath: 'circle(170% at calc(100% - 44px) 44px)', duration: 0.75, ease: 'power4.inOut' },
      );
      ...
      if (linksRef.current) {
        gsap.fromTo(
          ...
          { y: 28, opacity: 0 },
          { y: 0, opacity: 1, duration: 0.5, stagger: 0.055, delay: 0.3, ease: 'power3.out' },
        );
      }
      ...
      if (ctaRef.current) {
        gsap.fromTo(
          ctaRef.current,
          { y: 20, opacity: 0 },
          { y: 0, opacity: 1, duration: 0.45, delay: 0.65, ease: 'power3.out' },
        );
      }
    } else {
