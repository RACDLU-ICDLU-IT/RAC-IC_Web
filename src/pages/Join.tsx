...
export default function Join() {
  ...
  // Per club policy: editable any time before admin approval/rejection;
  // if rejected, editing resumes only after the applicant has requested
  // reconsideration (server-side enforced too, in upsert_application).
  const isApplicationEditable = (app: any) => {
    if (!app) return false;
    const status = (app.status || 'pending').toLowerCase();
    if (status === 'approved') return false;
    if (status === 'rejected') return !!app.reconsideration_requested;
    return true;
  };
  ...
  const handleVerifyCode = async () => {
    ...
    try {
      ...
      if (data.has_application && data.application) {
        ...
        // status view instead of the blank form.
        ...
        {step === 'payment' && application && (
          ...
          >
            <div className="text-center mb-8">
              ...
              >
                <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="#3b82f6">
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    strokeWidth={2}
            ...
            >
              ...
              <div className="flex items-center justify-between mb-2 flex-wrap gap-2">
                ...
                <span className="text-xl font-mono font-bold tracking-wider" style={{ color: '#e2136e' }}>
            ...
            <form onSubmit={handlePaymentSubmit(onSubmitPayment)} className="space-y-6">
              <div>
                <label className="block text-sm font-bold mb-2" style={{ color: '#374151' }}>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                ...
                >
                  ...
                  <p className="text-lg font-bold" style={{ color: applicationStatusMeta(application.status).color }}>
                ...
                >
                  ...
                  <p className="text-lg font-bold" style={{ color: paymentStatusMeta(application.payment_status).color }}>
              ...
              {/* Reconsideration already requested notice */}
