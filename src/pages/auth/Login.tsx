    ...
    <>
      <style>{`
        ...
        .lr {
          ...
          --neu-bg:        var(--color-page-bg, #e0e5ec);
          --neu-dark:      color-mix(in srgb, var(--neu-bg) 82%, #000);
          --neu-light:     color-mix(in srgb, var(--neu-bg) 60%, #fff);
          --neu-text:      #3d4468;
          --neu-muted:     #9499b7;
          --neu-icon:      #6c7293;
          --neu-err:       #e53e3e;
        ...
        <div className="lr-left">
          <div className="lr-brand">
            <div className="lr-brand-logo-wrap">
              <div className="lr-brand-logo-mask" role="img" aria-label={clubName} />
            </div>
