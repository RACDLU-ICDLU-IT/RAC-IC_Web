...
// ─── Color Variables ──────────────────────────────────────────────────────────
// All colors are defined via CSS custom properties. No hardcoded colors.
// Background is light & neutral by default (not dark black).
  ...
  return (
    <>
      <style>{`
        ...
        :root {
          /* Light, neutral base — no dark black backgrounds */
          --clr-bg: #f6f5f2;
          --clr-bg-mid: #f0efec;
          --clr-bg-rich: #e8e6e2;
          
          --clr-primary: #c41e50;
          --clr-primary-deep: #a51642;
          ...
          --clr-border-focus: rgba(196, 30, 80, 0.4);
          
          --clr-text: #1a1a1c;
          --clr-text-muted: #5a5a5e;
          --clr-text-faint: #9a9a9e;
          
          --clr-card-bg: rgba(255, 255, 255, 0.65);
          --clr-left-glass-start: rgba(245, 240, 235, 0.92);
          --clr-left-glass-end: rgba(235, 228, 222, 0.96);
          --clr-left-border-glow: rgba(196, 30, 80, 0.25);
          
          --clr-orb-primary: rgba(196, 30, 80, 0.08);
          --clr-orb-primary-light: rgba(196, 30, 80, 0.05);
          
          --shadow-sm: 0 1px 2px rgba(0, 0, 0, 0.04);
          --shadow-md: 0 4px 12px rgba(0, 0, 0, 0.06);
          --shadow-lg: 0 24px 48px rgba(0, 0, 0, 0.08);
          --shadow-primary: 0 4px 12px rgba(196, 30, 80, 0.2);
          --shadow-primary-hover: 0 8px 24px rgba(196, 30, 80, 0.25);
        ...
        .lr-scanline {
          ...
          left: 0; right: 0;
          height: 2px;
          background: linear-gradient(90deg, transparent, var(--clr-primary-soft), transparent);
        ...
        .lr-left-glass {
          position: absolute; inset: 0;
          background: linear-gradient(135deg, var(--clr-left-glass-start), var(--clr-left-glass-end));
        ...
        .lr-left-border {
          ...
          background: linear-gradient(180deg,
            transparent 0%,
            var(--clr-left-border-glow) 20%,
            var(--clr-left-border-glow) 50%,
            var(--clr-left-border-glow) 80%,
            transparent 100%);
        ...
        .lr-orb-1 {
          ...
          background: radial-gradient(circle, var(--clr-orb-primary) 0%, transparent 70%);
        ...
        .lr-orb-2 {
          ...
          background: radial-gradient(circle, var(--clr-orb-primary-light) 0%, transparent 70%);
          bottom: 0; right: 0;
        ...
        .lr-right-orb1 {
          ...
          background: radial-gradient(circle, var(--clr-orb-primary) 0%, transparent 65%);
        ...
        .lr-right-orb2 {
          position: absolute;
          width: 400px; height: 400px;
          background: radial-gradient(circle, var(--clr-orb-primary-light) 0%, transparent 65%);
        ...
        .lr-card-glass {
          ...
          padding: 40px 36px;
          box-shadow:
            0 0 0 1px var(--clr-primary-glow),
            var(--shadow-sm),
            var(--shadow-md),
            var(--shadow-lg),
        ...
        .lr-card-glass::after {
          ...
          background: radial-gradient(circle, var(--clr-primary-soft) 0%, transparent 70%);
          pointer-events: none;
        }
        ...
        .lr-input::placeholder { color: var(--clr-text-faint); opacity: 0.6; }
        ...
        .lr-input:focus {
          ...
          background: var(--clr-primary-soft);
          box-shadow: 0 0 0 3px var(--clr-primary-glow), var(--shadow-sm);
        }
        ...
        .lr-input:-webkit-autofill:focus {
          -webkit-box-shadow: 0 0 0 100px var(--clr-bg-mid) inset !important;
        ...
        .lr-input-wrap:focus-within .lr-input-icon { color: var(--clr-primary); }

        .lr-eye-btn {
          position: absolute; right: 11px; top: 50%; transform: translateY(-50%);
          background: none; border: none; cursor: pointer; padding: 5px;
          color: var(--clr-text-faint); border-radius: 7px;
          display: flex; align-items: center; justify-content: center;
        ...
        .lr-btn:hover:not(:disabled) {
          ...
          box-shadow: var(--shadow-sm), var(--shadow-primary-hover), var(--shadow-inset-light);
      ...
      <div className="lr">
        ...
        <div className="lr-left">
          ...
          <div className="lr-gears">
            <div className="lr-gear-1"><GearIcon size={280} opacity={0.08} speed={40} /></div>
            <div className="lr-gear-2"><GearIcon size={90} opacity={0.12} speed={20} reverse /></div>
            <div className="lr-gear-3"><GearIcon size={44} opacity={0.1} speed={12} /></div>
          </div>
            ...
            <div className="lr-brand">
              <div className="lr-brand-icon">
                <svg width="20" height="20" viewBox="0 0 100 100" fill="none">
                  <path d="M43.3 5.7l-2.8 8.6a35 35 0 0 0-8.7 3.6L23 14.6l-9.1 9 3.3 8.7a35 35 0 0 0-3.6 8.7L5 43.3v12.9l8.6 2.8a35 35 0 0 0 3.6 8.7L14 76.5l9 9 8.7-3.3a35 35 0 0 0 8.7 3.6l2.8 8.6h12.9l2.8-8.6a35 35 0 0 0 8.7-3.6l8.7 3.3 9-9-3.3-8.7a35 35 0 0 0 3.6-8.7L95 56.6V43.7l-8.6-2.8a35 35 0 0 0-3.6-8.7l3.3-8.7-9-9-8.7 3.3a35 35 0 0 0-8.7-3.6L56.7 5.7H43.3zM50 35a15 15 0 1 1 0 30 15 15 0 0 1 0-30z" fill="currentColor"/>
                </svg>
              </div>
