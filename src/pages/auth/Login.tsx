  ...
  return (
    <>
      <style>{`
        ...
        .lr-brand-logo-wrap img {
          width:28px; height:28px; object-fit:contain;
          /* tint to accent color */
          filter: invert(17%) sepia(80%) saturate(2000%) hue-rotate(320deg) brightness(85%);
        }
        ...
        .lr-right {
          ...
          padding:40px 24px;
          /* Extra top padding so navbar doesn't clip card on mobile */
          padding-top: max(80px, env(safe-area-inset-top, 80px));
        }
        @media (min-width:900px) { .lr-right { padding-top:40px; } }
        ...
        @media (min-width:900px) { .lr-logo-circle { display:none; } }
        .lr-logo-outer {
        ...
        /* No inner square — just the logo image directly in the circle */
        .lr-logo-outer img {
      ...
      <div className="lr">
        ...
        <div className="lr-left">
          <div className="lr-brand">
            <div className="lr-brand-logo-wrap">
        ...
        <div className="lr-right">
          <div className={`lr-card${shake ? ' shake' : ''}`}>
            ...
            {/* Mobile logo — circle only, no inner square */}
