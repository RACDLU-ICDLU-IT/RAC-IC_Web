...
const INJECTED_ID = '__home_mobile_styles__';
if (typeof document !== 'undefined' && !document.getElementById(INJECTED_ID)) {
  ...
  s.textContent = `
    ...
    /* Suppress old absolutely-positioned logo if it leaks in */
    .hv2-hero > .hv2-hero__logo-mobile {
    ...
    /* ── Hero logo: flows naturally between headline and meta ── */
  ...
  return (
    <div className="bg-[var(--color-page-bg)] overflow-x-hidden">
      ...
      >
        ...
        {/* TOP: Headline + Logo stacked naturally */}
        <div className="relative max-w-7xl mx-auto px-6 w-full pt-30" style={{ zIndex: 5 }}>
          <h1
            ref={headlineRef}
