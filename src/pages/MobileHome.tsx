...
if (typeof document !== 'undefined' && !document.getElementById(INJECTED_ID)) {
  ...
  s.textContent = `
    ...
    /* â”€â”€ Hero logo: mobile = absolute center, desktop = inline below headline â”€â”€ */
    ...
    /* â”€â”€ Events (inverted with accent background, like mission banner) â”€â”€ */
    .hv2-events-inverted {
...
export default function Home() {
  ...
  const [content, setContent] = useState<any>({
    ...
    homeHeroSubtitle: `${tenant.fullName.toUpperCase()} â€” ${tenant.district}`,
    ...
    <div className="bg-[var(--color-page-bg)] overflow-x-hidden">
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-12 w-full pt-30 md:pt-34" style={{ zIndex: 5 }}>
          ...
          {/* DESKTOP ONLY: logo inline below headline, left-aligned */}
          {tenantLogoUrl && (
      ...
      <section ref={aboutRef} className="hv2-about hv2-reveal" style={{ marginTop: 0 }}>
        ...
        <div className="hv2-about__content" style={{ background: 'var(--color-page-bg)' }}>
          ...
          <p className="hv2-about__body">
            ...
            joining us, you don't just volunteer â€” you learn how to lead.
          </p>
        ...
        <div className="hv2-donate__inner">
          ...
          <div className="hv2-donate__left">
            ...
            <p className="hv2-donate__body">
              Every contribution â€” big or small â€” empowers us to run impactful programs,
