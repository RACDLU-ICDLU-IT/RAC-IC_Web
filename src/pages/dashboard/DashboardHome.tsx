    ...
    <div className="rac-dashboard-home">
      ...
      <style>{`
        ...
        /* Needs attention → announcement row links. Kept as its own
           ...
           `style` can't express :hover. Visuals otherwise match the
           card's previous static rows exactly (same font-size/color/
           line-height as the old "3 dues unpaid" / "TRF Chair
