...
if (typeof document !== 'undefined' && !document.getElementById(INJECTED_ID)) {
  ...
  s.textContent = `
    ...
    /* CHANGE 2 — Mobile: show image above left content */
    @media (max-width: 900px) {
      .hv2-join__grid {
    ...
    /* CHANGE 3 — Areas of Focus responsive images */
    .hv2-focus-mobile { display: block; }
    .hv2-focus-desktop { display: none; }
    @media (min-width: 769px) {
      .hv2-focus-mobile { display: none; }
      .hv2-focus-desktop { display: block; }
    }
    ...
    <div className="bg-[var(--color-page-bg)] overflow-x-hidden">
      ...
      >
        <div className="hv2-join__grid max-w-7xl mx-auto">
          ...
          {/* CHANGE 1 — RIGHT: tenant-specific image, full bleed, no overlay/cards */}
      ...
      {/* ════════════════════════════════════════
          CHANGE 3 — AREAS OF FOCUS
      ════════════════════════════════════════ */}
      <section style={{ background: '#ffffff', padding: '0', margin: '0' }}>
        {/* Mobile image */}
        <img
          src="https://res.cloudinary.com/dpaeapdp6/image/upload/yqmidupa6wxeyiu1gazo.png"
          alt="Areas of Focus"
          className="hv2-focus-mobile"
