...
export default function Home() {
  ...
  // Determine which logo to display based on tenant ID
  const getTenantLogo = () => {
    if (tenant.id === 'icdlu') {
  ...
  return (
    <div className="bg-[var(--color-page-bg)] overflow-x-hidden">
      ...
      {/* ════════════════════════════════════════
          HERO (Redesigned with Logo & Rotary Line)
      ════════════════════════════════════════ */}
      <section
        ref={heroRef}
        className="hv2-hero"
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full py-24 md:py-32">
          ...
          {/* Full-width Logo (conditional based on tenant) */}
          {tenantLogoUrl && (
