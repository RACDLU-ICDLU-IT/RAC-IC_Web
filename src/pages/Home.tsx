...
if (typeof document !== 'undefined' && !document.getElementById(INJECTED_ID)) {
  ...
  s.textContent = `
    ...
    .hv2-hero__headline {
      /* Scale aggressively — left column is ~50vw wide, so 8vw fills it well.
         Cap at 130px to prevent overflow even on ultra-wide screens. */
    ...
    .hv2-hero__meta-name {
      /* 2.8vw at 1400px ≈ 39px — visually matches button width */
