...
if (typeof document !== 'undefined' && !document.getElementById(INJECTED_ID)) {
  ...
  s.textContent = `
    ...
    .hv2-btn-join-custom {
      ...
      color: var(--color-hero-start) !important;
    ...
    /* ── Hero logo: mobile = absolute center, desktop = inline below headline ── */
    .hv2-hero__logo-mobile {
      position: absolute;
      top: 55%;
      left: 50%;
    ...
    .hero-desktop-left .hv2-hero__headline {
    ...
    .hero-desktop-buttons .hv2-btn-primary,
    .hero-desktop-buttons .hv2-btn-ghost {
      width: 100%;
      flex: none;
    }
    @media (max-width: 768px) {
    ...
    .hv2-donate__btn:hover {
      transform: translateY(-3px);
      box-shadow: 0 20px 48px rgba(0,0,0,0.22);
    }
    .hv2-donate__btn-icon {
    ...
    .hv2-donate__card-title {
      font-size: 15px;
      font-weight: 800;
      letter-spacing: -0.01em;
      margin-bottom: 6px;
    }
    .hv2-donate__card-desc {
      font-size: 13px;
      color: #9ca3af;
      line-height: 1.6;
    }
  ...
  return (
    <div className="bg-[var(--color-page-bg)] overflow-x-hidden">
      ...
      >
        ...
        <div className="hero-mobile-layout" style={{ display: 'block', width: '100%', flex: 1 }}>
          {/* MOBILE ONLY: logo absolutely centered in hero body */}
          {tenantLogoUrl && (
            <div className="hv2-hero__logo-mobile">
              <img
                src={tenantLogoUrl}
          ...
          <div className="relative max-w-7xl mx-auto px-6 md:px-12 w-full pt-30 md:pt-34" style={{ zIndex: 5 }}>
            ...
            {/* DESKTOP ONLY: logo inline below headline, left-aligned (hidden on mobile) */}
            {tenantLogoUrl && (
              <div className="hv2-hero__logo-desktop">
                <img
                  src={tenantLogoUrl}
                  alt={`${tenant.shortName} emblem`}
                  style={{
        ...
        <div className="hero-desktop-layout">
          <div className="hero-desktop-inner">
            ...
            {/* Right column: logo + club name + district + buttons */}
            <div className="hero-desktop-right">
              {tenantLogoUrl && (
                <div className="hero-desktop-logo">
                  <img
                    src={tenantLogoUrl}
                    alt={`${tenant.shortName} emblem`}
                    style={{
              ...
              <div className="hero-desktop-name" style={{ color: heroTextColor }}>
                {tenant.fullName}
              </div>
              <div className="hero-desktop-district" style={{ color: heroTextColor }}>
                Rotary International D64, Bangladesh
              </div>
              <div className="hero-desktop-buttons">
                ...
                <Link to="/about" className="hv2-btn-ghost" style={{ color: heroTextColor }}>
                  Learn More
                </Link>
              </div>
            </div>
      ...
      <section className="hv2-donate hv2-reveal">
        <div className="hv2-donate__inner">
          {/* Left: copy + CTA */}
          <div className="hv2-donate__left">
          ...
          {/* Right: impact cards staggered grid */}
          <div className="hv2-donate__right">
            {[
              {
                icon: <Users size={20} color="white" />,
                title: 'Feed a Family',
                desc: 'A small gift provides meals and essentials to a family in need for a week.',
              },
              {
                icon: <Globe size={20} color="white" />,
                title: 'Fund a Project',
                desc: 'Help us launch community service initiatives that create lasting local impact.',
              },
              {
                icon: <Heart size={20} color="white" />,
                title: 'Sponsor Youth',
                desc: 'Give a young leader access to mentorship, training, and fellowship programs.',
              },
              {
                icon: <MapPin size={20} color="white" />,
                title: 'Reach Further',
                desc: 'Extend our outreach to more communities across Bangladesh and beyond.',
              },
            ].map((card, i) => (
