...
export default function Home() {
  ...
  return (
    <div className="bg-[var(--color-page-bg)] overflow-x-hidden">
      ...
      >
        {/* Mobile: flex column (image on top, text below). Desktop: grid 50/50. */}
        <div style={isMobile ? {
          display: 'flex',
          ...
          {/* MOBILE ONLY — image renders first, fixed height, no overflow */}
          {isMobile && joinRightImageUrl && (
            <div style={{
              width: '100%',
              height: 260,
              flexShrink: 0,
          ...
          <div style={{
            ...
            padding: isMobile ? '40px 24px' : '100px 80px',
          }}>
            <div style={{
          ...
          {/* DESKTOP ONLY — right column image, absolutely fills its grid cell */}
          {!isMobile && joinRightImageUrl && (
