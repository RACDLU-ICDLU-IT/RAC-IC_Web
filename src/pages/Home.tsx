...
if (typeof document !== 'undefined' && !document.getElementById(INJECTED_ID)) {
  ...
  s.textContent = `
    ...
    /* Right column: logo top, card bottom — fills full height */
    .hv2-hero__right {
      display: flex;
      flex-direction: column;
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const syncHeight = () => {
      ...
      if (rightH <= 0) return;
      // h1 fills leftEl. We want the text block height ≈ rightH.
      // Binary-search the font-size so the h1 natural height = rightH.
      ...
      // Final: use lo (largest size that still fits)
