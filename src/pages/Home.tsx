...
if (typeof document !== 'undefined' && !document.getElementById(INJECTED_ID)) {
  ...
  s.textContent = `
    ...
    /* FIX 1+2: Reduced top padding via pt-10, and meta-line margin/gap tightened */
    .hv2-hero__meta-line {
      display: flex;
      flex-direction: column;
      align-items: center;
    ...
    /* Custom join button styles (white bg, pinkish text) */
    .hv2-btn-join-custom {
    ...
    /* FIX 4: Center the Apply for Membership button on mobile */
    .hv2-btn-white {
      display: inline-flex; align-items: center; justify-content: center; gap: 10px;
    ...
    /* FIX 3: Tighter gap between club name and RID64 line */
    ...
    @media (max-width: 640px) {
      ...
      /* FIX 1: Reduced top padding on mobile too */
      .hv2-hero__meta-line {
        margin-top: 16px;
        padding-top: 20px;
      }
  ...
  return (
    <div className="bg-[var(--color-page-bg)] overflow-x-hidden">
      ...
      >
        ...
        {/* FIX 1: Reduced top padding from py-24/py-32 to pt-10/pb-16 */}
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full pt-10 pb-16 md:pt-14 md:pb-24">
          {/* Tagline Headline */}
          <h1
            ref={headlineRef}
          ...
          {/* Club details + Rotary line + Buttons container */}
          <div className="hv2-hero__meta-line" style={{ borderTopColor: `${heroTextColor}25` }}>
            ...
            {/* FIX 3: margin-top: 0 on rotary line (handled in CSS), gap reduced in .hv2-hero__meta-line */}
      ...
      >
        <div className="hv2-join__grid max-w-7xl mx-auto">
          <div className="hv2-join__left">
            ...
            {/* FIX 4: Centered via width:100% on .hv2-btn-white + justify-content:center wrapper */}
