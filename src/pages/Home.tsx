...
export default function Home() {
  ...
  return (
    <div className="bg-[var(--color-page-bg)] overflow-x-hidden">
      ...
      >
        {/* On mobile: flex column, image on top. On desktop: grid 50/50 */}
        <div style={isMobile ? {
          display: 'flex',
          ...
          {/* On mobile: image renders FIRST (before left content) */}
          {isMobile && joinRightImageUrl && (
            <div style={{ width: '100%', height: 280, overflow: 'hidden', flexShrink: 0 }}>
              <img
          ...
          {/* RIGHT image — desktop only (mobile renders it above) */}
          {!isMobile && joinRightImageUrl && (
