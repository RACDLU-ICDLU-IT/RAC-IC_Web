      ...
      >
        ...
        {tenantLogoUrl && (
          <div style={{
            ...
            <img
              ...
              style={{ maxWidth: 320, width: '100%', height: 'auto', objectFit: 'contain' }}
            />
          </div>
        )}

        {/* TOP: headline — sits near top (logo removed) */}
        <div className="relative max-w-7xl mx-auto px-6 md:px-12 w-full pt-32 md:pt-36" style={{ zIndex: 5 }}>
          <h1
            ref={headlineRef}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full pb-8 md:pb-12">
          <div className="hv2-hero__meta-line" style={{ borderTopColor: `${heroTextColor}25` }}>
            ...
            <div className="hv2-hero__rotary-line" style={{ color: heroTextColor, marginTop: '-4px' }}>
