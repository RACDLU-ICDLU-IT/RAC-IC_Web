...
if (typeof document !== 'undefined' && !document.getElementById(INJECTED_ID)) {
  ...
  s.textContent = `
    ...
    .hv2-hero {
      position: relative;
      min-height: 100svh;
      /* FIX: flex column so content sits top-to-bottom without orphaned empty row */
      display: flex;
    ...
    /* FIX: meta-line stacks vertically so club name gets full width */
    .hv2-hero__meta-line {
      display: flex;
      flex-direction: column;
    ...
    /* FIX: buttons side-by-side, equal width, no text wrap */
    ...
    /* Inside mission the bg IS the accent/primary color — override to white */
    ...
    .hv2-btn-primary {
      ...
      /* FIX: never wrap text, equal flex width */
      flex: 1;
      white-space: nowrap;
    }
    ...
    @media (max-width: 640px) {
      ...
      /* FIX: smaller button padding on very small screens so text never wraps */
      .hv2-btn-primary,
      .hv2-btn-ghost {
        padding: 13px 16px;
        font-size: 11px;
    ...
    <div className="bg-[var(--color-page-bg)] overflow-x-hidden">
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full py-24 md:py-32">
          ...
          {/* Meta line — club name full width, then equal-width buttons below */}
          <div className="hv2-hero__meta-line">
            <p className="hv2-hero__meta-name" style={{ color: heroTextColor }}>
              {tenant.fullName.split(' ').map((word: string, i: number) => (
        ...
        {/* FIX: "SCROLL" hint removed entirely — was creating unnecessary dead space */}
      </section>
      ...
      <section
        ...
        style={{
          background: isLight ? 'var(--color-accent)' : 'var(--color-primary)',
          color: '#ffffff',
          marginTop: 120,
        }}
      >
        ...
        <span className="hv2-mission__large-word font-heading" style={{ color: '#ffffff' }}>
          Service
        </span>
      </section>
      ...
      {/* ════════════════════════════════════════
          ABOUT SPLIT
      ════════════════════════════════════════ */}
      <section ref={aboutRef} className="hv2-about hv2-reveal" style={{ marginTop: 80 }}>
        {/* FIX: removed the floating dark glass badge — it was covering faces in the photo */}
