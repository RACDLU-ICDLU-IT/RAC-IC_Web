...
if (typeof document !== 'undefined' && !document.getElementById(INJECTED_ID)) {
  ...
  s.textContent = `
    ...
    .hv2-hero__meta-line {
      ...
      flex-direction: column;
      align-items: center;
      gap: 4px;                 /* reduced gap between club name and district */
      padding-top: 0;           /* no extra padding – club name sits directly above district */
    ...
    .hv2-hero__rotary-line {
      ...
      opacity: 0.7;
      margin-top: 0;
      margin-bottom: 0;        /* removed bottom margin – sits tight under club name */
      text-align: center;
    }
    ...
    /* ── Logo – now a direct flex child, vertically centered ── */
    .hv2-hero__logo {
      display: flex;
      justify-content: center;
      flex: 1;                 /* takes all remaining space, centers logo */
      align-items: center;
    }
    .hv2-hero__logo img {
      width: 100%;
...
export default function Home() {
  ...
  return (
    <div className="bg-[var(--color-page-bg)] overflow-x-hidden">
      ...
      {/* ════════════════════════════════════════
          HERO — three direct children: headline, logo, meta-line
      ════════════════════════════════════════ */}
      <section
        ref={heroRef}
        className="hv2-hero"
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full flex flex-col justify-between" style={{ height: '100%' }}>
          {/* 1. Headline */}
          <div className="pt-34 md:pt-38">
            <h1
              ref={headlineRef}
          ...
          {/* 2. Logo – flex:1 centers it vertically */}
          {tenantLogoUrl && (
            <div className="hv2-hero__logo">
              <img
                src={tenantLogoUrl}
          ...
          {/* 3. Meta-line (club name, district, buttons) */}
      ...
      <section
        ...
        style={{ background: isLight ? 'var(--color-accent)' : '#000251', color: 'white', marginTop: 80 }}
      >
        <div className="hv2-join__grid max-w-7xl mx-auto">
          ...
          <div className="hv2-join__right">
            <div style={{
              position: 'absolute', inset: 0,
              background: 'rgba(0,0,0,0.15)', backdropFilter: 'blur(40px)',
            }} />
