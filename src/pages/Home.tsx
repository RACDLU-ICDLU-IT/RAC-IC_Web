...
if (typeof document !== 'undefined' && !document.getElementById(INJECTED_ID)) {
  ...
  s.textContent = `
    ...
    .hv2-hero__headline {
      /* Scale by viewport HEIGHT so the 3-line headline fills the same
         vertical space as the right column content regardless of screen size.
         11svh × 3 lines × 0.92 line-height ≈ 30svh of text block height,
         which matches the logo+name+buttons stack on the right.
         Max 112px prevents overflow on very tall screens / ultra-wide. */
      font-size: clamp(60px, 11svh, 112px);
      font-weight: 900;
      line-height: 0.92;
    ...
    /* Left column: headline flush left, vertically centred */
    .hv2-hero__left {
      display: flex;
      flex-direction: column;
      justify-content: center;
    ...
    /* Right column: no border, just centered */
    .hv2-hero__right {
      display: flex;
      flex-direction: column;
      justify-content: center;
