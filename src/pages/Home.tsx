...
if (typeof document !== 'undefined' && !document.getElementById(INJECTED_ID)) {
  ...
  s.textContent = `
    ...
    /* ── MOBILE layout — stacked, same as original ── */
    @media (max-width: 900px) {
      ...
      .hv2-hero__logo-wrap {
        margin-bottom: 0;
        /* Mobile: logo absolutely centered in hero body for original look */
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    /* ── Stats ribbon ── */
    .hv2-stats { position: relative; z-index: 20; }
    .hv2-stats__card {
    ...
    .hv2-mission .hv2-section-eyebrow { color: rgba(255,255,255,0.6); }
    .hv2-mission .hv2-section-eyebrow::before { background: rgba(255,255,255,0.5); }
    ...
    @media (min-width: 768px) { .hv2-mission { padding: 80px 0; } }
    .hv2-mission__quote {
    ...
    @media (min-width: 900px) { .hv2-about__image-wrap { min-height: 100%; } }
    .hv2-about__image-wrap img {
      width: 100%; height: 100%;
      object-fit: cover; object-position: center top;
      transition: transform 0.8s ease; min-height: 340px;
    }
    ...
    @media (max-width: 900px) { .hv2-about__content { padding: 56px 24px 40px; } }
    .hv2-about__heading {
    ...
    /* ── Events (inverted) ── */
    .hv2-events-inverted { background: var(--color-accent); color: white; }
    .hv2-events-inverted .hv2-section-eyebrow { color: rgba(255,255,255,0.6); }
    .hv2-events-inverted .hv2-section-eyebrow::before { background: white; }
    .hv2-events-inverted .events-header-link { color: white; opacity: 0.8; transition: opacity 0.2s; text-decoration: none; }
    .hv2-events-inverted .events-header-link:hover { opacity: 1; }
    ...
    .hv2-events__item-inverted:hover { background: rgba(255,255,255,0.05); }
    .hv2-events__date-month-inverted {
      font-size: 10px; font-weight: 800; letter-spacing: 0.2em;
      text-transform: uppercase; margin-bottom: 4px; color: rgba(255,255,255,0.7);
    }
    .hv2-events__date-day-inverted { font-size: 40px; font-weight: 900; line-height: 1; color: white; }
    .hv2-events__pill-inverted {
      font-size: 9px; font-weight: 800; letter-spacing: 0.15em;
      text-transform: uppercase; padding: 4px 10px; border-radius: 999px;
      display: inline-block; background: rgba(255,255,255,0.2); color: white; margin-bottom: 8px;
    }
    .hv2-events__title-inverted { font-size: 20px; font-weight: 800; letter-spacing: -0.02em; margin-bottom: 4px; color: white; }
    .hv2-events__venue-inverted { font-size: 13px; color: rgba(255,255,255,0.6); display: flex; align-items: center; gap: 6px; }
    .hv2-events__arrow-inverted { opacity: 0; transition: opacity 0.2s, transform 0.2s; color: white; }
    .hv2-events__item-inverted:hover .hv2-events__arrow-inverted { opacity: 1; transform: translateX(4px); }
    ...
    @media (max-width: 768px) {
      .hv2-gallery__grid { grid-template-columns: repeat(2, 1fr); grid-template-rows: auto; }
    }
    .hv2-gallery__cell {
      position: relative; overflow: hidden;
      border-radius: 12px; cursor: pointer; background: #e5e7eb;
    }
    ...
    .hv2-gallery__cell img { width: 100%; height: 100%; object-fit: cover; transition: transform 0.6s cubic-bezier(0.4,0,0.2,1); }
    ...
    .hv2-join__headline {
      ...
      font-weight: 900; line-height: 1; letter-spacing: -0.04em; margin-bottom: 24px;
    }
    .hv2-join__sub { font-size: 17px; line-height: 1.7; opacity: 0.75; margin-bottom: 40px; max-width: 440px; }
    .hv2-join__chips { display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 40px; }
    .hv2-join__chip {
      font-size: 11px; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase;
      padding: 8px 16px; border-radius: 999px;
      background: rgba(255,255,255,0.12); border: 1px solid rgba(255,255,255,0.2);
    }
    .hv2-join__right-img-wrap { overflow: hidden; }
    @media (max-width: 900px) {
      .hv2-join__grid { grid-template-columns: 1fr !important; display: grid !important; }
      .hv2-join__left-inner { padding: 48px 24px !important; }
      .hv2-join__right-img-wrap {
        order: -1; height: auto !important; aspect-ratio: 1 / 1 !important;
    ...
    .hv2-lightbox__counter {
      ...
      font-size: 11px; font-weight: 700; letter-spacing: 0.2em; color: rgba(255,255,255,0.4);
    }
    .hv2-lightbox__caption {
      position: absolute; bottom: 60px; left: 50%; transform: translateX(-50%);
      background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.12);
      backdrop-filter: blur(12px); border-radius: 999px; padding: 8px 20px;
      font-size: 13px; color: rgba(255,255,255,0.8); white-space: nowrap;
    }

    /* ── Outline button (used in about) ── */
    .hv2-btn-outline {
      display: inline-flex; align-items: center; gap: 10px;
      padding: 14px 28px; border-radius: 12px;
      font-size: 13px; font-weight: 800;
      letter-spacing: 0.05em; text-transform: uppercase;
      background: transparent; color: var(--color-accent, #0070c9);
      border: 2px solid currentColor; cursor: pointer;
      transition: background 0.15s, color 0.15s; text-decoration: none;
    }
    .hv2-btn-outline:hover { background: var(--color-accent, #0070c9); color: white; }

    /* ── White button (used in join) ── */
    .hv2-btn-white {
    ...
    .hv2-btn-white:hover { transform: translateY(-2px); box-shadow: 0 16px 40px rgba(0,0,0,0.25); }

    /* ── Donate ── */
    .hv2-donate { position: relative; overflow: hidden; background: var(--color-page-bg); padding: 100px 0; }
    .hv2-donate__inner {
      position: relative; z-index: 2;
      max-width: 72rem; margin: 0 auto; padding: 0 24px;
      display: grid; grid-template-columns: 1fr 1fr; gap: 80px; align-items: center;
    }
    @media (max-width: 900px) { .hv2-donate__inner { grid-template-columns: 1fr; gap: 48px; } }
    .hv2-donate__headline { font-size: clamp(36px, 5vw, 64px); font-weight: 900; line-height: 1.0; letter-spacing: -0.04em; margin-bottom: 20px; }
    .hv2-donate__body { font-size: 17px; line-height: 1.75; color: #6b7280; margin-bottom: 36px; max-width: 440px; }
    .hv2-donate__btn {
    ...
    .hv2-donate__btn:hover { transform: translateY(-3px); box-shadow: 0 20px 48px rgba(0,0,0,0.22); }
    .hv2-donate__right { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; }
    .hv2-donate__card {
      background: var(--color-page-bg); border: 1px solid rgba(0,0,0,0.07);
      border-radius: 20px; padding: 28px 24px;
      box-shadow: 0 4px 24px rgba(0,0,0,0.05); transition: transform 0.2s, box-shadow 0.2s;
    }
    .hv2-donate__card:hover { transform: translateY(-4px); box-shadow: 0 16px 40px rgba(0,0,0,0.1); }
    .hv2-donate__card-icon {
      width: 44px; height: 44px; border-radius: 12px; background: var(--color-accent);
      display: flex; align-items: center; justify-content: center; margin-bottom: 16px; opacity: 0.9;
    }
    .hv2-donate__card-title { font-size: 15px; font-weight: 800; letter-spacing: -0.01em; margin-bottom: 6px; }
    .hv2-donate__card-desc { font-size: 13px; color: #9ca3af; line-height: 1.6; }
    .hv2-donate__divider { width: 48px; height: 3px; background: var(--color-accent); border-radius: 2px; margin-bottom: 28px; }

    /* ── Responsive misc ── */
    @media (max-width: 640px) {
      .hv2-stats__card { grid-template-columns: 1fr; border-radius: 20px; }
      .hv2-stats__item + .hv2-stats__item::before { top: 0; left: 20%; width: 60%; height: 1px; }
      .hv2-events__item-inverted { grid-template-columns: 60px 1fr; gap: 16px; padding: 24px 0; }
      .hv2-events__date-day-inverted { font-size: 28px; }
      .hv2-events__title-inverted { font-size: 18px; }
    }
  `;
    ...
    <div className="bg-[var(--color-page-bg)] overflow-x-hidden">
      ...
      >
        ...
        <div className="hv2-hero__inner">
          ...
          {/* ── LEFT: tagline ── */}
          <div className="hv2-hero__left">
            <div className="hv2-hero__eyebrow" style={{ color: heroTextColor }}>
              {tenant.id === 'icdlu' ? 'Interact Club' : 'Rotaract Club'} · District 64
            </div>
            <h1
              ref={headlineRef}
          ...
          {/* ── RIGHT: logo + club info + buttons ── */}
          <div
            className="hv2-hero__right"
            style={{ borderLeftColor: `${heroTextColor}18` }}
          >
            {/* Logo — mobile: absolute center via CSS, desktop: inline here */}
            {tenantLogoUrl && (
            ...
            <div
              className="hv2-hero__club-name"
              style={{ color: heroTextColor }}
            >
              {tenant.fullName}
            </div>
            <div
              className="hv2-hero__district"
              style={{ color: heroTextColor }}
            >
            ...
            <div
              className="hv2-hero__divider"
              style={{ background: `${heroTextColor}20` }}
            />

            <div className="hv2-hero__btn-stack">
              <Link
                to="/join"
                className="hv2-btn-primary"
                style={{ color: `var(--color-hero-start)` }}
              >
              ...
              <Link
                ...
                style={{ color: heroTextColor, borderColor: `${heroTextColor}40` }}
              >
                Learn More
              </Link>
            </div>
        ...
        <img
          src={
            isMobile
              ...
              : 'https://res.cloudinary.com/dpaeapdp6/image/upload/a8os8483ulybux9irnco.png'
          }
          alt="Areas of Focus"
          ...
          {joinRightImageUrl && (
            ...
            >
              <img
                ...
                alt="Join the club"
                style={{ width: '70%', height: 'auto', maxWidth: '100%', maxHeight: '100%', objectFit: 'contain', display: 'block' }}
              />
            </div>
          )}
        </div>
      ...
      {/* DONATE */}
      <section className="hv2-donate hv2-reveal">
        <div className="hv2-donate__inner">
          <div>
            <div className="hv2-section-eyebrow">Make a Difference</div>
            <div className="hv2-donate__divider" />
            <h2 className="hv2-donate__headline font-heading" style={headingColorStyle}>
              Your generosity<br />fuels change.
            </h2>
            <p className="hv2-donate__body">
              Every contribution — big or small — empowers us to run impactful programs,
              support underprivileged communities, and build the next generation of leaders
              right here in Bangladesh.
            </p>
            <Link to="/donate" className="hv2-donate__btn">
              Donate Now <ArrowUpRight size={16} />
            </Link>
          </div>
          <div className="hv2-donate__right">
            {[
              { icon: <Users size={20} color="white" />, title: 'Feed a Family', desc: 'A small gift provides meals and essentials to a family in need for a week.' },
              { icon: <Globe size={20} color="white" />, title: 'Fund a Project', desc: 'Help us launch community service initiatives that create lasting local impact.' },
              { icon: <Heart size={20} color="white" />, title: 'Sponsor Youth', desc: 'Give a young leader access to mentorship, training, and fellowship programs.' },
              { icon: <MapPin size={20} color="white" />, title: 'Reach Further', desc: 'Extend our outreach to more communities across Bangladesh and beyond.' },
            ].map((card, i) => (
              <div key={i} className="hv2-donate__card">
                <div className="hv2-donate__card-icon">{card.icon}</div>
                <div className="hv2-donate__card-title">{card.title}</div>
                <div className="hv2-donate__card-desc">{card.desc}</div>
              </div>
            ))}
          </div>
        </div>
