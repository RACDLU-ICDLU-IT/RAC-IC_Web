...
if (typeof document !== 'undefined' && !document.getElementById(INJECTED_ID)) {
  ...
  s.textContent = `
    ...
    /* New hero bottom bar: left/right split */
    .hv2-hero__bottom-bar {
      display: flex;
      justify-content: space-between;
    ...
    /* ── Events inverted (accent background) ── */
    .hv2-events-inverted {
  ...
  return (
    <div className="bg-[var(--color-page-bg)] overflow-x-hidden">
      ...
      >
        ...
        {/* BOTTOM BAR: left club info + right buttons */}
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full pb-8 md:pb-12">
          <div className="hv2-hero__bottom-bar">
            <div className="hv2-hero__club-info">
              <div className="hv2-hero__club-name">{tenant.fullName}</div>
              <div className="hv2-hero__rotary-line">Rotary International D64, Bangladesh</div>
            </div>
            <div className="hv2-hero__buttons">
